...
export const ModalOpenFranchise = ({ active, setActive }) => {
  return (
    <div className={`${active ? 'fixed' : 'hidden'} w-[100vw] h-auto top-0 left-0 z-10 bg-white`}>
      <div className=" h-[100%] flex flex-col relative w-[100%] items-center ">
        ...
        <div className=" flex flex-col w-[79%] bg-white h-[100%] gap-[30px] items-center ">
          <h2 className="  max-md:text-[13px] max-lg:text-[18px] text-[20px] uppercase mt-5 ">Оставьте вашу заявку</h2>
          <div className=" max-lg:border-none max-lg:flex-col max-lg:w-[100%] w-[80%] flex gap-[20px] border-r-10 border-[#A49986] rounded-r-[90px] rounded-l-[90px] ">
            <img className=" max-lg:hidden max-xl:w-[50%] " src="/src/assets/images/franchise/application02.png"></img>
            <div className=" max-lg:w-[100%] max-lg:items-center  flex flex-col gap-[40px] w-[47%] justify-center ">
              <p className=" text-center font-normal ">Оставьте заявку на открытие Франшизы</p>
              <form className=" max-lg:h-[100%] max-md:w-[100%] max-lg:w-[60%] flex flex-col items-center gap-[30px] ">
          ...
          <h3 className="  max-md:text-[13px] max-lg:text-[18px] uppercase text-[20px] w-[90%] text-right">Мы обязательно свяжемся с вами</h3>
        </div>
      </div>
    </div>
  );
